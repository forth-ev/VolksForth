...
\ volksFORTH Loadscreen for py65 target         cas   06july2024
forth definitions
: (C [compile] ( ; IMMEDIATE  \ : ) ; IMMEDIATE

$0205 CONSTANT BASEADDR       \ change target base address here
BASEADDR DISPLACE !
...
CR .( SAVE-TARGET CERBERUS 2100 6502 VOLKSFORTH )
...
\ Coldstartvalues and user variables            cas   06july2024
\
...
\ Bootlabel
," VolksForth-83 3.8.1 cerb2100/6502  06jul2024  CS"
...
\ INPUT STRINGS               24DEC83KS)        cas   06july2024

VARIABLE #TIB   0 #TIB !
VARIABLE >TIB   $EE00 >TIB !   \  050 ALLOT
VARIABLE >IN    0 >IN !
VARIABLE BLK    0 BLK !
...
| : (COLD INIT-VOCABULARYS  INIT-BUFFERS  PAGE 'COLD ONLYFORTH
   ." volksforth 3.8.1 cerberus 2100/6502" CR   RESTART ;
    -2 ALLOT
