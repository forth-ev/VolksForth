...
Dieses File enth„lt den 68000-Assembler fr volksFORTH-83.      
Der Assembler basiert auf dem von Michael Perry fr F83 entwik- 
kelten, enth„lt aber einige zus„tzliche Features.               
Wegen der Heap-Struktur im volksFORTH sind z.B. echte Labels    
verwendbar. Aus Geschwindigkeitsgrnden enth„lt der Assembler   
kaum Fehlerberprfung, es empfiehlt sich daher, nach getaner   
Tat die Code-Worte mit einem Disassembler zu berprfen.        
...
tionszeit zur Verfgung steht, aber keinen Platz im Dictionary  
