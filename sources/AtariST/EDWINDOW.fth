...
Dieses File enthÑlt das Editorfenster. Es kann als Beispiel fÅr 
...
FÅr das Fenster werden einige Funktionen aus VDI gebraucht,     
 die auf diesem Screen zusammengestellt sind. Beschreibung siehe
 Beschreibung VDI (hoffentlich haben wir die schon!)            
                                                                
Im Grunde wird nur eine Routine benutzt, mit der man ein weiûes 
 Rechteck zum Lîschen des Fensterinhaltes erzeugen kann. Dies   
 erledigt fbox                                                  
...
Der gesamte Bildschirm wird in den dafÅr vorgesehenen Speicher- 
 bereich gerettet (auûerhalb des FORTH-Systems, versteht sich)  
Das Ganze umgekehrt stellt den Bildschirm wieder her. Diese     
 Funktionen sind recht nÅtzlich, weil man Werte noch sehen kann,
 die z.B. bei LIST weggescrollt wÅrden.                         
                                                                
\ *** Block No. 13 Hexblock D 
\ Windowcomponents and Windowsize                      14sep86we
                                                                
Die Bestandteile des Fensters werden einfach aufaddiert und     
als Konstante zur VerfÅgung gestellt.                           
                                                                
linke obere Ecke des Fensters in Bildschirmkoordinaten          
                                                                
Breite des Fensters in Bildschirmkoordinaten                    
Hîhe des Fensters in Bildschirmkoordinaten                      
                                                                
berechnet die Ausmaûe des Fensters fÅr alle weiteren Funktionen 
 unter Zuhilfenahme von WIND-CALC. Leider liefert diese Funktion
 bei Breite und Hîhe ein Pixel zu wenig. Digital Research allein
 mag wissen, warum ...                                          
...
zur Ausgabe eines Textes in Titel- oder Infozeile               
 Der String muû mit einer Null abgeschlossen sein.              
                                                                
gibt 0string in der Titelzeile aus.                             
gibt 0string in der Infozeile aus.                              
                                                                
Die Grîûe des vertikalen Sliders wird aus der Gesamtgrîûe des   
 Files, das editiert wird, berechnet.                           
                                                                
Die Position des vertikalen Sliders wird relativ zur Gesamtgrîûe
 des Files eingestellt.                                         
                                                                
\ *** Block No. 15 Hexblock F 
\ Draw window on screen                                14sep86we
                                                                
gibt die Grîûe eines kleinen Rechtecks sowie des ganzen Fensters
                                                                
                                                                
zeichnet ein wachsendes Rechteck (nur fÅrs Auge ...)            
zeichnet ein schrumpfendes Rechteck ( s.o.)                     
                                                                
lîscht den Innenraum des Fenster durch öberschreiben mit einem  
 weiûen Rechteck.                                               
...
îffnet das Editorfenster:  Bildschirminhalt merken              
 Fenster erzeugen mit entsprechender Grîûe und Attributen       
 Titel- und Infozeile lîschen                                   
 Fenster auf dem Bildschirm ausgeben und Inhalt lîschen         
                                                                
schlieût das Editorfenster:                                     
 Fenster vom Bildschirm und Åberhaupt entfernen                 
...
Der Screenmanager stellt eine Liste von Rechtecken zurVerfÅgung,
 die nach einer Aktion geÑndert worden sind.                    
