...
Pascal-, C- oder Modula-Programmierer zur VerfÅgung steht.      
FÅr eine genaue Beschreibung der einzelnen Routinen verweisen   
...
von Digital Research beibehalten; auch die öbergabeparameter    
der einzelnen Funktionen sind unverÑndert geblieben.            
Der Aufbau einer FORTH-Library mit 'Super-Befehlen' ist in      
Arbeit.                                                         
                                                                
Die Worte in diesem File werden sowohl fÅr VDI- als auch fÅr    
AES-Funktionen benîtigt.                                        
...
\\ st_load_fonts  st_unload_fonts                               
   wÑr auch ganz hÅbsch, hamse aber nich!                       
