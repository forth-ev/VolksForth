...
Dieses File soll eine kurze EinfÅhrung in das volksFORTH83      
...
Verlassen Sie dann bitte den Editor mit der Esc-Taste, tippen   
 Sie  EMPTY-BUFFERS  BYE  ein und drÅcken Sie die Return-Taste. 
                                                                
Danach sollten Sie Ihre Disketten kopieren und die 1ST_WORD-    
 Files ausdrucken, die Ihnen noch mehr Dinge erklÑren.          
...
Einige Files auf dieser Diskette enthalten sog. Shadow Screens. 
 ...
 hat dann einen Shadow Screen. EnthÑlt ein File Shadows, so     
 sind sie alle in der zweiten HÑlfte des Files abgespeichert.   
 Mit   SHADOW SCR  kînnen Sie dann bequem zwischen Programm-    
 und Shadow-Screen hin und herschalten.                         
                                                                
Mit VIEW kînnen Sie sofort die Stelle finden, an der ein        
 Forth-Wort gespeichert ist. Geben Sie einfach ein Wort ein,    
 drÅcken Sie die Return-Taste und schon sind Sie am Ort.... ,   
...
Auûerdem unterstÅtzt der Editor einen Zeilen- und Zeichenstack. 
 Falls Sie einen Screen umbauen wollen, kînnen Sie Zeilen auf   
...
Wenn Sie diesen Screen ruiniert haben, drÅcken Sie einfach      
 die UNDO-Taste und schon ist alles wieder in Ordnung.          
 GeÑnderte Screens werden nÑmlich nicht sofort auf die Diskette 
 geschrieben, sondern solange in Puffern aufbewahrt, bis kein   
 Puffer mehr frei ist. Solange sich ein Block in einem Puffer   
 befindet, kînnen Sie Ihre énderungen mit UNDO rÅckgÑngig machen
 Das volksFORTH hat ca. 8 solche Puffer, diese Zahl kînnen Sie  
 aber auch Ñndern. Wie, steht im Kapitel 'Getting started'.     
\ *** Block No. 3 Hexblock 3 
 ...
 geÑndert wurde, d.h. anders als sein Original auf der Diskette 
 aussieht.                                                      
...
Rechts oben auf diesem Screen sehen Sie meine ID. Sie besteht   
 ...
 haben. Nach UNDO steht dort natÅrlich wieder meine ID und      
 nicht mehr Ihre.                                               
                                                                
\ *** Block No. 4 Hexblock 4 
                                                      bp 27Aug86
Schlieûlich gibt es noch eine FÅlle von Mîglichkeiten, den      
 aktuellen Screen zu wechseln, Zeichen zu lîschen oder          
 einzufÅgen, Zeilen zu manipulieren und den Cursor zu bewegen.  
 Sie sollten sich mit diesen Mîglichkeiten vertraut machen, denn
 sie werden Ihr Programmiererdasein erleichtern.                
                                                                
Damit Åberlasse ich Sie Ihrer Neugier und bin gespannt, was     
 sie mit unserem Forth machen...                                
                                                                
                Bernd Pennemann                                 
                                                                
 P.S. Dieses File kînnen Sie mit  USE TUTORIAL.SCR  0 4 PTHRU   
  ausdrucken lassen ...                                         
